...
describe('PanelLayout', () => {
  ...
  it('renders left and right content', () => {
    const { getByText } = render(
      <PanelLayout leftContent={<div>Left Panel</div>} rightContent={<div>Right Panel</div>} />,
    )
  ...
  it('renders header when provided', () => {
    const { getByText } = render(
      <PanelLayout header={<div>Header Content</div>} leftContent={<div>Left</div>} rightContent={<div>Right</div>} />,
    )
    expect(getByText('Header Content')).toBeInTheDocument()
  })

  it('does not render header when not provided', () => {
    const { queryByText } = render(<PanelLayout leftContent={<div>Left</div>} rightContent={<div>Right</div>} />)
    expect(queryByText('Header Content')).not.toBeInTheDocument()
  })

  it('renders TabBar and TabPanel', () => {
    const { getByTestId } = render(<PanelLayout leftContent={<div>Left</div>} rightContent={<div>Right</div>} />)
  ...
  it('renders resize handles with slider role', () => {
    const { getByLabelText } = render(<PanelLayout leftContent={<div>Left</div>} rightContent={<div>Right</div>} />)
  ...
  it('shows "Show Output Panel" button when bottom panel hidden', () => {
    ...
    const { getByText } = render(<PanelLayout leftContent={<div>Left</div>} rightContent={<div>Right</div>} />)
  ...
  it('shows mobile menu items when More is clicked', () => {
    const { getByLabelText, getByText } = render(
      <PanelLayout leftContent={<div>Left</div>} rightContent={<div>Right</div>} />,
    )
