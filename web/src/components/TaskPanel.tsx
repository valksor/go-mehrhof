    ...
    <div className="h-full overflow-auto p-4">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          {displayTask.branch && <MetadataItem label="Branch" value={displayTask.branch} mono />}
          {displayTask.worktreePath && (
            <MetadataItem label="Worktree" value={displayTask.worktreePath.split('/').slice(-2).join('/')} mono />
          )}
        </div>
      </div>
    </div>
