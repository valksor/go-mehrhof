          ...
          {loading && eventNames.length === 0 ? (
            ...
            <div className="space-y-4">
              {eventNames.map((event) => (
                <div key={event}>
                  <h4 className="text-xs font-semibold uppercase tracking-wider text-base-content/60 mb-2">{event}</h4>
                    ...
                    {hooks[event].map((hook, i) => (
                      <div key={i} className="flex items-start gap-2 p-2 rounded-lg bg-base-200">
                        ...
                        <div className="min-w-0">
                          <div className="text-sm font-medium truncate">{hook.description || hook.command}</div>
                          {hook.description && (
