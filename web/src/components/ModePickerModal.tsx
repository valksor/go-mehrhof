  ...
  return (
    ...
    >
      <div className="bg-base-200 rounded-2xl shadow-2xl p-8 max-w-lg w-full">
        <h2 id="mode-picker-title" className="text-2xl font-bold text-center mb-2">
          Welcome to kvelmo
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-sm text-base-content/60">
              Load tasks and let the AI handle it. Streamlined step-by-step workflow. Advanced tools available in
              Developer mode.
            </p>
          </button>
