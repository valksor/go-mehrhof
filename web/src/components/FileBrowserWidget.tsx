                  ...
                  <span className="flex-shrink-0 w-4 h-4 text-base-content/50">
                    {entry.is_dir ? (
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        className="w-4 h-4 text-warning/70"
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
            ...
            {[...entries.filter((e) => e.is_dir), ...entries.filter((e) => !e.is_dir)].map((entry) => (
              ...
              >
                ...
                {!entry.is_dir && entry.size !== undefined && (
                  <span className="flex-shrink-0 text-xs text-base-content/40">{formatBytes(entry.size)}</span>
                )}
                ...
                {entry.is_dir && (
                  <svg
                    aria-hidden="true"
                    className="w-3 h-3 text-base-content/30 flex-shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
