...
1. **Start** — Describe what you want, or pull from GitHub, GitLab, Linear, Wrike
2. **Plan** — Review the specification before any changes happen
3. **Implement** — Watch your agent build; undo anytime
4. **Review** — Approve before it ships
5. **Submit** — Create a PR

Every step creates a checkpoint. Use undo/redo if something doesn't look right.
...
- [Recovery Guide](/guides/recovery.md) — Troubleshooting
- [GitHub Issues](https://github.com/valksor/kvelmo/issues) — Bug reports
