...
func TestHandleStatic_SPAFallback_DeepRoute(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodGet, "/project/123/tasks", nil)
	w := httptest.NewRecorder()
...
func TestHandleWorktreeWS_PathWithoutPrefix(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodGet, "/ws/other/path", nil)
	w := httptest.NewRecorder()
...
func TestHandleStatic_NestedAssets(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), http.MethodGet, "/assets/images/logo.svg", nil)
	w := httptest.NewRecorder()
